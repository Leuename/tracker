...
- **resumed-by:** [Ten Closed, and a Backup Nobody Had Deployed](../handoff/2026-09-03%20Ten%20Closed,%20and%20a%20Backup%20Nobody%20Had%20Deployed.md) is the current entry point (phases 31-34). Its first instruction is to confirm the nightly backup manifest: the fixes that make it complete were pushed on 2026-09-03 and the job has never run with them.
