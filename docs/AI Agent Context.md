...
- **resumed-by:** [Exchange Rates, R7, and Two Agent Audits](../handoff/2026-09-04%20Exchange%20Rates,%20R7,%20and%20Two%20Agent%20Audits.md) is the **current entry point** and a **complete continuation package** (phases 37-44): a fresh chat resumes from that file alone. It carries traps 64-71, decisions D42-D46, both external-agent audits, and the three decisions waiting on the owner (C1 sign-out scope, C4 notification channel, C5 the deferred password rotation).
- **previously-resumed-by:** [Ten Closed, and a Backup Nobody Had Deployed](../handoff/2026-09-03%20Ten%20Closed,%20and%20a%20Backup%20Nobody%20Had%20Deployed.md) is the current entry point and a **complete continuation package** (phases 31-36): a fresh chat resumes from that file alone. Its first instruction is to confirm the nightly backup manifest: the fixes that make it complete were pushed on 2026-09-03 and the job has never run with them.
...
- **awaiting-decision-in:** [Remaining Work and Owner Decisions](Remaining%20Work%20and%20Owner%20Decisions.md) is the **current** open-items record: two items blocked on a `postgres` connection string, two on a disposable target, and five awaiting an owner decision — each with what is true today, what it costs, and a recommendation. **blocks:** nothing proceeds on A1/A2 without the connection string, or on C1-C5 without an answer.
...
- Resuming a session, or picking up work someone else left: start at [Ten Closed, and a Backup Nobody Had Deployed](../handoff/2026-09-03%20Ten%20Closed,%20and%20a%20Backup%20Nobody%20Had%20Deployed.md) and paste its single `## Resume prompt`, then read the two 2026-09-04 notes for what has happened since. Handing work to an **external** agent instead: use [Open Items Brief for Codex](../handoff/2026-09-04%20Open%20Items%20Brief%20for%20Codex.md), which carries exact relative paths rather than wikilinks.
