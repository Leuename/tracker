...
> **global** and is now explicit at both browser call sites ([D47](../docs/Decisions.md)), the scheduler gets
> **no external notification channel** ([D48](../docs/Decisions.md), which also closes D31), and the rates-account
> password rotation was **deferred again** ([D44](../docs/Decisions.md)) and remains open as C5.
> **Do not ask the owner to choose C1 or C4 again.** This file is kept as the dated record of
> what was open before those answers. Current state: [Three Answers, and a Finding That Corrected Itself](2026-09-04%20Three%20Answers,%20and%20a%20Finding%20That%20Corrected%20Itself.md)
